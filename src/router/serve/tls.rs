...
fn serve_dual_protocol<'a>(
	...
	// let passed_addrs: Vec<SocketAddr> = listeners
	// 	.iter()
	// 	.map(|listener| listener.local_addr())
	// 	.try_collect()?;

	// if !passed_addrs.is_empty() {
	// 	info!("Listening plain & TLS on passed sockets {passed_addrs:?}");
	// }

	// if !addrs.is_empty() {
	// 	info!("Listening plain & TLS on {addrs:?}");
	// }
...
fn serve_tls<'a>(
	...
	// if !passed_addrs.is_empty() {
	// 	info!("Listening TLS on passed sockets {passed_addrs:?}");
	// }

	// if !addrs.is_empty() {
	// 	info!("Listening TLS on {addrs:?}");
	// }
